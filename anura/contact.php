...
<img src="https://via.placeholder.com/1568x280?text=Visit+Blogging.com+Now" alt="">
  ...
  <div class="container mo-con mt-5">
    <div class="row contact-row">
      <div class="col-md-7">
        ...
        <form class="formulier mb-4" action="contactform.php" method="POST">
      ...
      <div class="col-md-4 ">
        <div class="card mb-3 cardcontact shadow-sm  bg-white rounded">
          <div class="card-body">
        ...
        <div class="card cardcontact  example shadow-sm  bg-white rounded">
          <div class="card-body">
  ...
  <footer class="container-fluid foot-con">
    ...
    <div class="row ">
      <div class="col-md-6 mt-2 mt-sm-2 text-left text-white">
  ...
  <script src="https://kit.fontawesome.com/8d99a94045.js" crossorigin="anonymous"></script>
